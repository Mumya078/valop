        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{route('admin.index')}}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-0" style="font-size: 20px;">
                Company Name
              </span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item" id="messages">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="#" class="menu-link">
                    <div data-i18n="Notifications">Read</div>
                  </a>
                </li>
              </ul>
            </li>
            <!-- Reservation -->
            <li class="menu-item" id="reservation">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <div data-i18n="Notifications">Reservations</div>
                  </a>
                  <ul class="menu-sub">
                    <li class="menu-item">
                      <a href="#" class="menu-link">
                    ...
                    <li class="menu-item">
                      <a href="#" class="menu-link">
                        <div data-i18n="Notifications">Accepted</div>
                      </a>
                    </li>
                    <li class="menu-item">
                      <a href="#" class="menu-link">
                        <div data-i18n="Notifications">Cancelled</div>
                      </a>
                    </li>
                  </ul>
                </li>
              ...
              <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="ui-alerts.html" class="menu-link">
                    <div data-i18n="Alerts">Customer</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="ui-alerts.html" class="menu-link">
                    <div data-i18n="Alerts">New Users</div>
                  </a>
                </li>
              </ul>
            </li>
            <!-- Role -->
            <li class="menu-item" id="role">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-box"></i>
                <div data-i18n="User interface">Role</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="ui-accordion.html" class="menu-link">
                ...
                <li class="menu-item">
                  <a href="ui-alerts.html" class="menu-link">
                    <div data-i18n="Alerts">Create New</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <!-- Working Hour -->
            <li class="menu-item" id="workinghour">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-box"></i>
                <div data-i18n="User interface">Working Hours</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="#" class="menu-link">
                    <div data-i18n="Accordion">Working Hours</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="#" class="menu-link">
            ...
            <!-- Reservation Setting -->
            <li class="menu-item" id="reservationsetting">
              <a href="#" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Reservation Settings</div>
              </a>
            </li>
            <!-- Social Media -->
            <li class="menu-item" id="socialmedia">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-box"></i>
                <div data-i18n="User interface">Social Media</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="#" class="menu-link">
            ...
            <!-- Slider -->
            <li class="menu-item" id="slider">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div data-i18n="Authentications">Slider</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="#" class="menu-link">
